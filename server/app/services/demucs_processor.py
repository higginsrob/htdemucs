...
class DemucsProcessor:
    ...
    def process_job(self, job_id: str):
        ...
        # Just log that it's been queued
        queue_pos = self.job_manager.get_queue_position(job_id)
        logger.info(f"Job {job_id} queued for processing (position: {queue_pos})")
        ...
        try:
            ...
            try:
                ...
                if job.source_type == 'youtube':
                    ...
                    # Update job with actual filename and metadata
        ...
        try:
            ...
            with zipfile.ZipFile(zip_path, 'w', zipfile.ZIP_DEFLATED) as zipf:
                ...
                if metadata_path.exists():
                    ...
                    logger.info(f"Added metadata.json to ZIP for job {job_id}")
